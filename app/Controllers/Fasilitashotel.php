...
class Fasilitashotel extends BaseController
{
    ...
    public function tambah(){
        ...
        if($this->validate($aturanform)){
          ...
          $foto->move('uploads');
            ...
            return redirect()->to(site_url('/fasilitashotel'))->with('info',
    ...
    public function edit($id_fasilitas_hotel=null){
        ...
        return 
        redirect()->to(site_url('/fasilitashotel'))->with('info','<div class="alert alert-success">Data berhasil diupdate</div>');
        }
